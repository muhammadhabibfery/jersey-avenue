<div>
    ...
    <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-center py-2">
            <div>
                <p class="text-sm text-gray-700 leading-5 sm:mb-3">
                ...
                <span class="relative z-0 inline-flex rounded-md shadow-sm">
                    ...
                    <span
                        ...
                        <span aria-current="page">
                            <span
                                class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-400 bg-white border border-blue-300 shadow-lg cursor-default leading-5 select-none">{{
                                $page }}</span>
                        </span>
                        @else
